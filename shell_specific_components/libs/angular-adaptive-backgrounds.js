...
(function () {
    ...
    }).directive('adaptiveBackground', ["$window", "adaptiveBackgroundsOptions", "$rootScope", function ($window, adaptiveBackgroundsOptions, $rootScope) {
        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                setColors = function (colors) {
                    $rootScope.dwdc = colors.dominant;
                    console.log($rootScope.dwdc);
                    var yiq;
